...
type CollectionProvider interface {
	GetCollection(ctx context.Context, playlistID string) (*models.MediaItem[*types.Collection], error)
	...
	AddCollectionItem(ctx context.Context, playlistID string, itemID string) error
	AddCollectionItems(ctx context.Context, playlistID string, itemIDs []string) error
