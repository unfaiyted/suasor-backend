...
*/
func (a *UserServiceApiService) PostUsersByIdConfigurationPartial(ctx context.Context, body interface{}, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *UserServiceApiService) PostUsersByUseridTypedsettingsByKey(ctx context.Context, body interface{}, userId string, key string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
