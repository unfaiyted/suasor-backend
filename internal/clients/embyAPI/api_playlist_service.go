...
func (a *PlaylistServiceApiService) GetPlaylistsByIdAddtoplaylistinfo(ctx context.Context, ids string, id string, localVarOptionals *PlaylistServiceApiGetPlaylistsByIdAddtoplaylistinfoOpts) (interface{}, *http.Response, error) {
	var (
