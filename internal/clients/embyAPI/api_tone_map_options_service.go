...
*/
func (a *ToneMapOptionsServiceApiService) PostEncodingFulltonemapoptions(ctx context.Context, body interface{}) (*http.Response, error) {
	var (
...
*/
func (a *ToneMapOptionsServiceApiService) PostEncodingPublictonemapoptions(ctx context.Context, body interface{}) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
