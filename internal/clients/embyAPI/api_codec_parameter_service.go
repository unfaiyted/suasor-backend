...
*/
func (a *CodecParameterServiceApiService) PostEncodingCodecparameters(ctx context.Context, body interface{}, codecId string, parameterContext MediaEncodingCodecParameterContext) (*http.Response, error) {
	var (
