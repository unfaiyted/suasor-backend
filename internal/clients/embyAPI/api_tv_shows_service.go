...
func (a *TvShowsServiceApiService) GetShowsByIdEpisodes(ctx context.Context, id string, localVarOptionals *TvShowsServiceApiGetShowsByIdEpisodesOpts) (QueryResultBaseItemDto, *http.Response, error) {
	var (
