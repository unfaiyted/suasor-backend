...
func (a *ImageServiceApiService) PostItemsByIdImagesByType(ctx context.Context, body interface{}, id string, type_ ImageType, localVarOptionals *ImageServiceApiPostItemsByIdImagesByTypeOpts) (*http.Response, error) {
	var (
...
Requires authentication as administrator
  ...
  - @param index Image Index
*/
func (a *ImageServiceApiService) PostItemsByIdImagesByTypeByIndex(ctx context.Context, body interface{}, id string, type_ ImageType, index int32) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ImageServiceApiService) PostItemsByIdImagesByTypeByIndexUrl(ctx context.Context, id string, type_ ImageType, index int32, strUrl string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	localVarQueryParams.Add("Url", parameterToString(strUrl, ""))
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
func (a *ImageServiceApiService) PostUsersByIdImagesByType(ctx context.Context, body interface{}, id string, type_ ImageType, localVarOptionals *ImageServiceApiPostUsersByIdImagesByTypeOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
Requires authentication as user
  ...
  - @param index Image Index
*/
func (a *ImageServiceApiService) PostUsersByIdImagesByTypeByIndex(ctx context.Context, body interface{}, id string, type_ ImageType, index int32) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
