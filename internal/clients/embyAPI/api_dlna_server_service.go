...
*/
func (a *DlnaServerServiceApiService) PostDlnaByUuidConnectionmanagerControl(ctx context.Context, body interface{}, uuId string) (*http.Response, error) {
	var (
...
*/
func (a *DlnaServerServiceApiService) PostDlnaByUuidContentdirectoryControl(ctx context.Context, body interface{}, uuId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
