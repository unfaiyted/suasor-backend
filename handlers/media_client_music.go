// handlers/media_client_music.go
package handlers
...
type MediaClientMusicHandler[T clienttypes.MediaClientConfig] struct {
	musicService services.MediaClientMusicService[T]
}

// NewMediaClientMusicHandler creates a new media client music handler
func NewMediaClientMusicHandler[T clienttypes.MediaClientConfig](musicService services.MediaClientMusicService[T]) *MediaClientMusicHandler[T] {
	return &MediaClientMusicHandler[T]{
...
func (h *MediaClientMusicHandler[T]) GetTrackByID(c *gin.Context) {
...
func (h *MediaClientMusicHandler[T]) GetAlbumByID(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
...
func (h *MediaClientMusicHandler[T]) GetArtistByID(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
...
func (h *MediaClientMusicHandler[T]) GetTracksByAlbum(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
...
func (h *MediaClientMusicHandler[T]) GetAlbumsByArtist(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
...
func (h *MediaClientMusicHandler[T]) GetArtistsByGenre(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
...
func (h *MediaClientMusicHandler[T]) GetAlbumsByGenre(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
...
func (h *MediaClientMusicHandler[T]) GetTracksByGenre(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
...
func (h *MediaClientMusicHandler[T]) GetAlbumsByYear(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
...
func (h *MediaClientMusicHandler[T]) GetLatestAlbumsByAdded(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
...
func (h *MediaClientMusicHandler[T]) GetPopularAlbums(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
...
func (h *MediaClientMusicHandler[T]) GetPopularArtists(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
