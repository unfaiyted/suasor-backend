...
//	@Router			/client/{clientID}/user-data/{mediaType}/sync [post]
...
//	@Success		200			{object}	responses.APIResponse[[]models.UserMediaItemData[types.MediaData]]	"Successfully retrieved client media item data"
//	@Failure		400			{object}	responses.ErrorResponse[responses.ErrorDetails]						"Bad request"
//	@Failure		401			{object}	responses.ErrorResponse[responses.ErrorDetails]						"Unauthorized"
//	@Failure		500			{object}	responses.ErrorResponse[responses.ErrorDetails]						"Internal server error"
//	@Router			/client/{clientID}/user-data/{mediaType} [get]
...
//	@Failure		500				{object}	responses.ErrorResponse[responses.ErrorDetails]						"Internal server error"
//	@Router			/client/{clientID}/user-data/{mediaType}/{clientItemID} [get]
...
//	@Success		201				{object}	responses.APIResponse[models.UserMediaItemData[types.MediaData]]	"Play event recorded successfully"
//	@Failure		400				{object}	responses.ErrorResponse[responses.ErrorDetails]						"Bad request"
//	@Failure		401				{object}	responses.ErrorResponse[responses.ErrorDetails]						"Unauthorized"
//	@Failure		500				{object}	responses.ErrorResponse[responses.ErrorDetails]						"Internal server error"
//	@Router			/client/{clientID}/user-data/{mediaType}/{clientItemID}/play [post]
...
//	@Param			clientItemID	path		string																true	"Client Item ID"
//	@Param			mediaType		path		string																true	"Media type like movie, series, track, etc."
//	@Success		200				{object}	responses.APIResponse[models.UserMediaItemData[types.MediaData]]	"Successfully retrieved playback state"
//	@Failure		400				{object}	responses.ErrorResponse[responses.ErrorDetails]						"Bad request"
//	@Failure		404				{object}	responses.ErrorResponse[responses.ErrorDetails]						"Not found"
//	@Failure		500				{object}	responses.ErrorResponse[responses.ErrorDetails]						"Internal server error"
//	@Router			/client/{clientID}/user-data/{mediaType}/{clientItemID}/state [get]
...
//	@Success		200				{object}	responses.APIResponse[models.UserMediaItemData[types.MediaData]]	"Playback state updated successfully"
//	@Failure		400				{object}	responses.ErrorResponse[responses.ErrorDetails]						"Bad request"
//	@Failure		401				{object}	responses.ErrorResponse[responses.ErrorDetails]						"Unauthorized"
//	@Failure		500				{object}	responses.ErrorResponse[responses.ErrorDetails]						"Internal server error"
//	@Router			/client/{clientID}/user-data/{mediaType}/{clientItemID}/state [put]
