...
// MediaPlayHistoryHandler handles all media play history operations
type MediaPlayHistoryHandler struct {
	service services.MediaPlayHistoryService
}

// NewMediaPlayHistoryHandler creates a new media play history handler
func NewMediaPlayHistoryHandler(service services.MediaPlayHistoryService) *MediaPlayHistoryHandler {
	return &MediaPlayHistoryHandler{service: service}
}
...
func (h *MediaPlayHistoryHandler) RecordMediaPlay(c *gin.Context) {
	...
	playHistory := &models.MediaPlayHistoryGeneric{
		UserID:           req.UserID,
