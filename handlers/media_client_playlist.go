// handlers/media_client_playlist.go
package handlers
...
type MediaClientPlaylistHandler[T clienttypes.MediaClientConfig] struct {
	playlistService services.MediaClientPlaylistService[T]
}

// NewMediaClientPlaylistHandler creates a new media client playlist handler
func NewMediaClientPlaylistHandler[T clienttypes.MediaClientConfig](playlistService services.MediaClientPlaylistService[T]) *MediaClientPlaylistHandler[T] {
	return &MediaClientPlaylistHandler[T]{
...
func (h *MediaClientPlaylistHandler[T]) GetPlaylistByID(c *gin.Context) {
...
func (h *MediaClientPlaylistHandler[T]) GetPlaylists(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
...
func (h *MediaClientPlaylistHandler[T]) CreatePlaylist(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
...
func (h *MediaClientPlaylistHandler[T]) UpdatePlaylist(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
...
func (h *MediaClientPlaylistHandler[T]) DeletePlaylist(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
...
func (h *MediaClientPlaylistHandler[T]) AddItemToPlaylist(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
...
func (h *MediaClientPlaylistHandler[T]) RemoveItemFromPlaylist(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
...
func (h *MediaClientPlaylistHandler[T]) SearchPlaylists(c *gin.Context) {
	ctx := c.Request.Context()
	log := utils.LoggerFromContext(ctx)
