...
// 	mediaItem := models.NewMediaItem[mediatypes.Collection](mediatypes.MediaTypeCollection, data)
...
// 	collectionService services.ClientListService[T, *mediatypes.Collection]
// }
//
// // NewClientCollectionHandler creates a new media client collection handler
// func NewClientCollectionHandler[T clienttypes.ClientMediaConfig](
// 	collectionService services.ClientListService[T, *mediatypes.Collection],
// ) *ClientCollectionHandler[T] {
